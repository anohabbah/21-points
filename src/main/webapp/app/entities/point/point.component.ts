...
export class PointComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.pointService
        ...
        .subscribe(
          (res: HttpResponse<IPoint[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  protected onSuccess(data: IPoint[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
