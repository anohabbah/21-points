...
export class PreferenceComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number, dontNavigate?: boolean): void {
    ...
    if (this.currentSearch) {
      this.preferenceService
        ...
        .subscribe(
          (res: HttpResponse<IPreference[]>) => this.onSuccess(res.body, res.headers, pageToLoad, !dontNavigate),
          () => this.onError()
        );
      return;
    }
  ...
  registerChangeInPreferences(): void {
    this.eventSubscriber = this.eventManager.subscribe('preferenceListModification', () => this.loadPage());
  }
  ...
  protected onSuccess(data: IPreference[] | null, headers: HttpHeaders, page: number, navigate: boolean): void {
